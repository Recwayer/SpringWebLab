...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        BrandDTO brand = new BrandDTO(null, new Date(), new Date(), "Brand1");
        BrandDTO brand2 = new BrandDTO(null, new Date(), new Date(), "Brand2");
        brand = brandService.register(brand);
        brand2 = brandService.register(brand2);
        ModelDTO model = new ModelDTO(null, new Date(), new Date(), "Model1", Category.CAR, "image1.jpg", 2020, 2025, brand.getUuid());
        ModelDTO model2 = new ModelDTO(null, new Date(), new Date(), "Model2", Category.TRUCK, "image2.jpg", 2022, 2027, brand2.getUuid());
        ...
        UserDTO user = new UserDTO(null, new Date(), new Date(), "user1", "password1", "Andrey", "Karpushin", true, role.getUuid(), "image3.jpg");
        UserDTO user2 = new UserDTO(null, new Date(), new Date(), "user2", "password2", "Matvey", "Ivanov", true, role2.getUuid(), "image4.jpg");
